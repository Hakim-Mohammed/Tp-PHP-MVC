	...
	<nav class="light-green">
		<div class="container">
			<div class="nav-wrapper">
				...
				<a href="<?=ROOT_URL?>blog_index.html" class="brand-logo">Interviews Sportifs</a>
				...
				<ul class="right hide-on-med-and-down">
					...
					<li class="<?php echo ($_GET['a']=="chapters")?"active" : ""; ?>"><a href="<?=ROOT_URL?>blog_chapters.html">Les interviews</a></li>
